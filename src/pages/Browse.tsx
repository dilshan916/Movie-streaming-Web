  ...
  return (
    <>
      <div className="page-header">
        ...
        <div style={{ display: 'flex', alignItems: 'center', background: 'var(--bg-input, #1a1a1a)', border: '1px solid var(--border, #333)', borderRadius: 9999, padding: '10px 16px', gap: 12, width: '100%', maxWidth: 320 }}>
          <svg style={{ width: 18, height: 18, color: 'var(--text-muted, #aaa)', flexShrink: 0 }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" />
          </svg>
          <input
            type="text"
            style={{ flex: 1, background: 'transparent', border: 'none', color: 'var(--text-primary, #fff)', fontSize: 14, outline: 'none', minWidth: 0 }}
